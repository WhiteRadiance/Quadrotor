...
//#define SI24R1_CS 	PCout(4) 	//spi片选信号
//#define SI24R1_IRQ  	PAin(1)		//中断请求

#define SI24R1_CE		PAout(3)	//SI24R1的Enable,用于控制收发模式
#define SI24R1_CS 		PAout(4) 	//spi片选信号
#define SI24R1_IRQ  	PCin(4)		//中断请求
...
#define RF_CE_GPIO_CLK		RCC_APB2Periph_GPIOA	//对应的时钟
#define RF_CE_GPIO_PIN		GPIO_Pin_3				//PA3
// SI24R1_CS
#define RF_CS_GPIO_PORT		GPIOA
#define RF_CS_GPIO_CLK		RCC_APB2Periph_GPIOC	//对应的时钟
#define RF_CS_GPIO_PIN		GPIO_Pin_4				//PA4
// SI24R1_IRQ
#define RF_IRQ_GPIO_PORT	GPIOC
#define RF_IRQ_GPIO_CLK		RCC_APB2Periph_GPIOA	//对应的时钟
#define RF_IRQ_GPIO_PIN		GPIO_Pin_4				//PC4
...
#define AutoReTx_DELAY	0x30	//自动重传延时	  	 0x30=1000 us  0x20=750us	/ARD=500us is long enough for any ACK payload length in 1 or 2Mbps mode.
#define AutoReTx_COUNT	0x04	//最大自动重传次数	    4 times
#define RF_FREQUENCY	2		//RF通道频率		 2402 MHz(默认为2402MHz)

#define RF_PWR_7dBm		0x07	//TX发射功率 7dBm
#define RF_PWR_3dBm		0x05	//TX发射功率 3dBm
#define RF_PWR_0dBm		0x03	//TX发射功率 0dBm

#define RF_bps_2Mbps	0x08	//RF数据速率 2Mbit/s
#define RF_bps_1Mbps	0x00	//RF数据速率 1Mbit/s
