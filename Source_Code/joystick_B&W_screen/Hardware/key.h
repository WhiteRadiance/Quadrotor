...
#define key3 	GPIO_ReadInputDataBit(GPIOC,GPIO_Pin_3 )	//读取按键3, key_user1
#define key4 	GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_10)	//读取按键4, key_user2
