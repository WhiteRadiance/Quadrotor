...
{
	u8 prct = 0;
	if(volt <= 3.5)				prct = 0;					//3.5V ->  0%
	else if(volt <= 3.6)		prct = (volt-3.5)*50;		//3.6V ->  5%
	else if(volt <= 3.7)		prct = (volt-3.6)*100 + 5;	//3.7V -> 15%
	else if(volt <= 3.8)		prct = (volt-3.7)*250 + 15;	//3.8V -> 40%
	else if(volt <= 3.9)		prct = (volt-3.8)*250 + 40;	//3.9V -> 65%
	else if(volt <= 4.0)		prct = (volt-3.9)*250 + 65;	//4.0V -> 90%
	else if(volt <= 4.1)		prct = (volt-4.0)*70 + 90;	//4.1V -> 97%
	else if(volt <= 4.2)		prct = (volt-4.1)*30 + 97;	//4.2V ->100%
	else						prct = 222;					//超过4.2V为异常, 固定为222%
	return prct;
}
