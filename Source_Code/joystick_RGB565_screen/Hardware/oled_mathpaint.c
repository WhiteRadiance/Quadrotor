...
//画线长度是闭区间(包括端点)
void oled_draw_line(u8 x1, u8 y1, u8 x2, u8 y2, u16 exe)
{
...
//画矩形		 /exe=1执行  0删除
void oled_draw_rectangle(u8 x1, u8 y1, u8 x2, u8 y2, u16 exe)
{
...
//使用Bresenham算法画圆
void oled_draw_circle(u8 x0, u8 y0, u8 r, u16 exe)
{
